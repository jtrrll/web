{
  config.perSystem = _: {
    config.files.file.".github/workflows/update_dependencies.yaml".text = ''
        ...
        flake:
          ...
          steps:
            ...
            - name: Update flake.lock
              ...
              with:
                branch: "update_flake_lock_flake"
                inputs: files flake-parts nix-lib nixpkgs
                pr-title: "deps: update flake dependencies"
                pr-labels: |
                  automated
                  dependencies
          ...
          steps:
            ...
            - name: Update flake.lock
              ...
              with:
                ...
                inputs: determinate disko nixpkgs-nixos sops-nix
